...
resource "local_file" "ansible_inventory" {
  content = templatefile("${path.module}/../../../../../ansible/inventory/dev/proxmox/termix/inventory.tpl", {
    ip = split("/", proxmox_virtual_environment_container.termix-container.initialization[0].ip_config[0].ipv4[0].address)[0]
  })
  filename = "${path.module}/../../../../../ansible/inventory/dev/proxmox/termix/inventory.ini"
}
